...
class NewInvoiceActivity : AppCompatActivity(), AdapterView.OnItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        typeAdapter.addAll(InvoiceType.getObjects(applicationContext).sortedBy { x -> x.toString() })
        ...
        button.setOnClickListener {
            ...
            if (validateInputs()) {
                ...
                val entity = InvoiceEntity(null, payee, selectedType!!, amount, cal.time)

                replyIntent.putExtra(INVOICE_ENTITY, entity)
    ...
    companion object {
        const val INVOICE_ENTITY = "fi.tuni.sinipelto.laskuvelho.INVOICE_ENTITY"
    }
}